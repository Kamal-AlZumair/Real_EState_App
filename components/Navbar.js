      ...
      <Box>
        <Menu>
          ...
          <MenuList>
            ...
            <Link href={'/'} passHref><MenuItem icon={<FcAbout/>}>Buy Property</MenuItem></Link>
            <Link href={'/search?purpose=for-rent'} passHref><MenuItem icon={<FiKey/>}>Rent Property</MenuItem></Link>
            <Link href={'/search?purpose=for-sale'} passHref><MenuItem icon={<BsSearch/>}>Search</MenuItem></Link>
          </MenuList>
        </Menu>
      </Box>
    </Flex>
